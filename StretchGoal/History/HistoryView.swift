...
struct HistoryView: View {
    ...
    private struct Row: Identifiable {
        let day: DayKey
        let breaks: Int, water: Int, mindful: Int, active: Int, longestSit: Int, points: Int
        let allGoals: Bool
        var id: DayKey { day }
    }
    ...
    private var rows: [Row] {
        ...
        return model.recentDays.prefix(30).map { s in
            ...
            return Row(day: s.date, breaks: s.breaks, water: s.waterTaps, mindful: s.mindful, active: s.activeSeconds,
